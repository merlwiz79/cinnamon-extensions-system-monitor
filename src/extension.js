...
// system-monitor: Cinnamon extension displaying system informations in Cinnamon status bar, such as memory usage, cpu usage, network rates…
...
const Gettext = imports.gettext.domain('cinnamon-extensions-system-monitor');
...
var enable = function () {
    ...
    let _gsmPrefs = _appSys.lookup_app('cinnamon-system-monitor-config.desktop');
